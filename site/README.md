...
5. **Іконка застосунку** — `public/favicon.svg` зараз плейсхолдер (листок на
   шавлієвому тлі). Замінити на справжню іконку і виконати
   `npm run generate:assets` для перегенерації PNG-набору та og.png.
